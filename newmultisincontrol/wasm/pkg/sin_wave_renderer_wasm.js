/* @ts-self-types="./sin_wave_renderer_wasm.d.ts" */
 ...
 * @returns {boolean}
 */
export function add_amplitude_events(data) {
    const ptr0 = passArrayF32ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.add_amplitude_events(ptr0, len0);
    return ret !== 0;
}
 ...
 * @returns {boolean}
 */
export function add_frequency_events(data) {
    const ptr0 = passArrayF32ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.add_frequency_events(ptr0, len0);
    return ret !== 0;
}
 ...
 * @returns {Uint32Array}
 */
export function add_sines(phases) {
    const ptr0 = passArrayF32ToWasm0(phases, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.add_sines(ptr0, len0);
 ...
 * @returns {number}
 */
export function get_current_sample_position() {
    const ret = wasm.get_current_sample_position();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function num_sines() {
    const ret = wasm.num_sines();
    return ret >>> 0;
}
 ...
 * @returns {boolean}
 */
export function remove_sine(id) {
    const ret = wasm.remove_sine(id);
    return ret !== 0;
}
 ...
 * @returns {number}
 */
export function rms_snapshot_and_reset() {
    const ret = wasm.rms_snapshot_and_reset();
    return ret;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./sin_wave_renderer_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('sin_wave_renderer_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
